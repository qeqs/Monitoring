...
import social_network_authentication.VkAuthorization;

@ManagedBean(name = "vkAuth")
@ViewScoped
public class VkAuthController implements Serializable {
    ...
    public void setAuthCode(String authCode) {
        try {
            HashMap<String, String> map = vkBean.getUser(authCode);
            loginVk(map.get("nickname"), map.get("password"));
    ...
    public void loginVk(String username, String password) {
