...
import monitoringweb.beans.generatedControllers.sessions.MeasureFacade;
...
public class MeasureController implements Serializable {
    ...
    @EJB
    private monitoringweb.beans.generatedControllers.sessions.MeasureFacade ejbFacade;
