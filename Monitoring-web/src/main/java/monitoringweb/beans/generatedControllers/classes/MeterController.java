...
import monitoringweb.beans.generatedControllers.sessions.MeterFacade;
...
public class MeterController implements Serializable {
    ...
    @EJB
    private monitoringweb.beans.generatedControllers.sessions.MeterFacade ejbFacade;
