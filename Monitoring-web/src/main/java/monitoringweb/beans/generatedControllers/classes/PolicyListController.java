...
import monitoringweb.beans.generatedControllers.sessions.PolicyListFacade;
...
public class PolicyListController implements Serializable {
    ...
    @EJB
    private monitoringweb.beans.generatedControllers.sessions.PolicyListFacade ejbFacade;
