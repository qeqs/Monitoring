...
import monitoringweb.beans.generatedControllers.sessions.PolicyFacade;
...
public class PolicyController implements Serializable {
    ...
    @EJB
    private monitoringweb.beans.generatedControllers.sessions.PolicyFacade ejbFacade;
    ...
    public static class PolicyControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Policy) {
                ...
                return getStringKey(o.getIdPolicy());
            } else {
