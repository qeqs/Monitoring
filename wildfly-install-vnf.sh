...
EOF
    ...
    sed -i -e 's,$WILDFLY_HOME/bin/standalone.sh.*,$WILDFLY_HOME/bin/standalone.sh -c $2 -b $3 -Djboss.socket.binding.port-offset=100,g' $WILDFLY_DIR/bin/launch.sh
